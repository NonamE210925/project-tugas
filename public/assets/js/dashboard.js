(function($) {
  ...
  $(function() {
    ...
    if ($("#leaveReport").length) {
      ...
      var leaveReportData = {
          labels: ["Banjir","Longsor", "Kebakaran", "Angin Kencang", "Tanah Amblas"],
          datasets: [{
              label: 'Last week',
              data: [18, 25, 39, 11, 24],
              backgroundColor: "#52CDFF",
    ...
    if ($("#leaveReport01").length) {
      var leaveReportChart = document.getElementById("leaveReport01").getContext('2d');
      var leaveReportData = {
          labels: ["Banjir","Longsor", "Kebakaran", "Angin Kencang", "Tanah Amblas"],
          datasets: [{
              label: 'Last week',
      ...
      var leaveReport01 = new Chart(leaveReportChart, {
          type: 'bar',
          data: leaveReportData,
          options: leaveReportOptions
      });
